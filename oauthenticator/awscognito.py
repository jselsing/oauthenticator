"""
Custom Authenticator to use cognito OAuth2 with JupyterHub
"""
import base64
import os
...
class CognitoOAuthenticator(OAuthenticator):
    ...
    claim_groups_key = Union(
        ...
        config=True,
        help="""
        Userdata groups claim key present in the id token.
    ...
    username_key = Union(
        ...
        config=True,
        help="""
        Userdata username key present in the id token.
...
class LocalCognitoOAuthenticator(LocalAuthenticator, CognitoOAuthenticator):
